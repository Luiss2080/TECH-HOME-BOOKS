    ...
    <div class="panel-header">
        <div class="header-title">
            ...
            <div class="title-content">
                ...
                <p class="subtitle">Actualice los datos de la asignatura</p>
            </div>
        </div>
                ...
                <div class="help-section-container">
                    <div class="help-cards-list">
                        <div class="help-card-item">
                            ...
                            <div class="help-text">
                                <h4>Edición</h4>
                                <p>Modifique información académica.</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="form-grid">
                        <div class="form-group span-2">
                            ...
                            <div class="input-wrapper">
                                ...
                                <input type="text" id="nombre" name="nombre" class="form-input" placeholder="Ej: Física Fundamental" required value="{{ old('nombre', $materia->nombre) }}">
                            </div>
                        </div>
                         ...
                         <div class="form-group span-2">
                            ...
                            <div class="input-wrapper">
                                ...
                                <input type="text" id="codigo" name="codigo" class="form-input" placeholder="FIS-101" required value="{{ old('codigo', $materia->codigo) }}">
                            </div>
                        </div>

                        <div class="form-group span-4">
                            <label for="descripcion">Descripción</label>
                            <textarea id="descripcion" name="descripcion" class="form-textarea" placeholder="Breve descripción...">{{ old('descripcion', $materia->descripcion) }}</textarea>
                        </div>
                        ...
                        <div class="form-group span-2">
                            ...
                            <div class="input-wrapper">
                                ...
                                <input type="number" id="horas_semanales" name="horas_semanales" class="form-input" value="{{ old('horas_semanales', $materia->horas_semanales) }}" min="1">
                            </div>
                        </div>
                    </div>
